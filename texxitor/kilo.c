// Tu as stopper step 81 https://viewsourcecode.org/snaptoken/kilo/04.aTextViewer.html
    ...
    for (y = 0; y < E.screenrows; y++) {
        ...
        if(filerow >= E.numrows) {
            if (E.numrows == 0 && y == E.screenrows / 3) {
                char welcome[80];
                int welcomelen = snprintf(welcome, sizeof(welcome), "Texxitor -- version %s", TEXXITOR_VERSION);
